...
urlpatterns = patterns('',
    ...
    (r'^nb/catchstop(?:\/)*$', 'nextbus.catchStop'),
    (r'^catchstop/nb/_dflt(?:\/)*$', 'nextbus.catchStopDflt'),
    (r'^catchstop/nb/(?P<re>[\w|-]+?)(?:\/)*$', 'nextbus.catchStop'),
    (r'^catchstop/nb/(?P<re>[\w|-]+?)/(?P<agency>[\w|-]+?)(?:\/)*$', 'nextbus.catchStop'),
    (r'^catchstop/nb/(?P<re>[\w|-]+?)/(?P<agency>[\w|-]+?)/(?P<route>[\w|-]+?)(?:\/)*$', 'nextbus.catchStop'),
    (r'^catchstop/nb/(?P<re>[\w|-]+?)/(?P<agency>[\w|-]+?)/(?P<route>[\w|-]+?)/(?P<direction>[\w|-]+?)(?:\/)*$', 'nextbus.catchStop'),
    (r'^catchstop/nb/(?P<re>[\w|-]+?)/(?P<agency>[\w|-]+?)/(?P<route>[\w|-]+?)/(?P<direction>[\w|-]+?)/(?P<stop>[\w|-]+?)(?:\/)*$', 'nextbus.catchStop'),
